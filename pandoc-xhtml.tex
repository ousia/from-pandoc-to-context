...
\startxmlsetups xml:jul:footnotes
    \def\JULFootnotes_Title{\startmode[*en]\chapter{Notes}\stopmode\startmode[*es]\chapter{Notas}\stopmode\startmode[*deo]\chapter{Notizen}\stopmode\startmode[*de]\chapter{Notizen}\stopmode\startmode[*fr]\chapter{Notes}\stopmode}
    \JULFootnotes_Title\placefootnotes
\stopxmlsetups

\startxmlsetups xml:colophon
    \startbackmatter
    \startnotmode[nofootnotes,jul:footnotes]\startmode[endnotes]
...
\startxmlsetups xml:hidden:h1
    \doifdefined{hiddentitle}{\hiddentitle{\xmlflush{#1}}}
\stopxmlsetups
...
\def\url#1{\bgroup\tt\hw\goto{\hyphenatedurl{#1}}[url(#1)]\egroup}
