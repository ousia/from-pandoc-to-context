\startxmlsetups xml:pandoc
    ...
    \xmlsetsetup{\xmldocument}{html|body|head|div|h1|h2|h3|h4|h5|h6|p|blockquote|span|em|q|b|pre|code|strong|a|ul|ol|li|dl|hr|br|sup|sub}{xml:*}
...
\startxmlsetups xml:dl
    \description{\xmltext{#1}{dt}} \xmltext{#1}{dd}
\stopxmlsetups
