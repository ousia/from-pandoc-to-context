\startxmlsetups xml:pandoc
    ...
    \xmlsetsetup{\xmldocument}{div[@class='rights']}{xml:rights}
    \xmlsetsetup{\xmldocument}{div[@id='dedication']}{xml:dedication}
    \xmlsetsetup{\xmldocument}{div[@id='epigraph']}{xml:epigraph}
    \xmlsetsetup{\xmldocument}{div[@id='frontmatter']}{xml:frontmatter}
    \xmlsetsetup{\xmldocument}{div[@id='bodymatter']}{xml:bodymatter}
