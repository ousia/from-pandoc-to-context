...
\startxmlsetups xml:titlepage
    \startcoverpagemakeup
        ...
        \vfill
        \startalign[flushright]
        \dontleavehmode\scale[width=.5\textwidth]{\xmltext{#1}{p[@class='publisher']}}
        \stopalign
    \stopcoverpagemakeup
...
%%% in proper form (not sure whether LaTeX is included
%%% the only way to get them is (label in smallcaps):
...
\def\CoverImage{\doifsomethingelse{\CoverImageFile}{\CoverImageFile}{}}
