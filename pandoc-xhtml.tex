...
\startxmlsetups xml:juh:footnotes
    \def\JUHFootnotes_Title{\startmode[*en]\chapter{Notes}\stopmode\startmode[*es]\chapter{Notas}\stopmode\startmode[*deo]\chapter{Anmerkungen}\stopmode\startmode[*de]\chapter{Anmerkungen}\stopmode\startmode[*fr]\chapter{Notes}\stopmode}
    \JUHFootnotes_Title\placefootnotes
\stopxmlsetups
