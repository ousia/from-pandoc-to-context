\startxmlsetups xml:pandoc
    ...
    \xmlsetsetup{\xmldocument}{[@class='part']/h1}{xml:part}
    \xmlsetsetup{\xmldocument}{[@class='part']/h2}{xml:h1}
    \xmlsetsetup{\xmldocument}{[@class='hidden']/h1}{xml:hidden}
    \xmlsetsetup{\xmldocument}{[@class='hidden']/h1}{xml:hidden}
...
\startxmlsetups xml:titlepage
    \startcoverpagemakeup
        ...
        \vfill
        \WidthSpanningText{\xmltext{#1}{h1[@class='title']}}{\textwidth}{SerifBold}

        \startalign [flushright]
        \hfill\WidthSpanningText{\xmltext{#1}{h1[@class='subtitle']}}{.75\textwidth}{SerifItalic}
        \stopalign
        \vfill
        \startalign[center]
...
\startxmlsetups xml:colophon
    ...
    \startbackmatter
    \chapter{\translate[en=Notes, fr=Notes, es=Notas, deo=Notizen, de=Notizen]}
