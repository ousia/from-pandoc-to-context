\startxmlsetups xml:pandoc
    \xmlsetsetup{\xmldocument}
        {html|body|head|div|h1|h2|h3|h4|h5|h6|p|blockquote|span|em|q|b|strong|a|ul|ol|li|dl|dt|dd|hr|br|sup|sub|code}
        {xml:*}
    \xmlsetsetup{\xmldocument}
        {pre/code}
        {xml:pre:code}
    ...
    \xmlsetsetup{\xmldocument}
        ...
        {xml:appendices}
    \xmlsetsetup{\xmldocument}
        {[contains(@class,'frontmatter']}
        {xml:frontmatter}
    \xmlsetsetup{\xmldocument}
        {[contains(@class,'bodymatter']}
        {xml:bodymatter}
    \xmlsetsetup{\xmldocument}
        {[contains(@class,'backmatter']}
        {xml:backmatter}
    \xmlsetsetup{\xmldocument}
        {[contains(@class,'appendices']}
        {xml:appendices}
    \xmlsetsetup{\xmldocument}
        {[@id='colophon']}
        {xml:colophon}
...
\startxmlsetups xml:internal:link
    {\em\doiftext{\in[\cldcontext{string.sub([[\xmlatt{#1}{href}]],2)}]}{\in[\cldcontext{string.sub([[\xmlatt{#1}{href}]],2)}]. }\about[\cldcontext{string.sub([[\xmlatt{#1}{href}]],2)}]}
\stopxmlsetups
