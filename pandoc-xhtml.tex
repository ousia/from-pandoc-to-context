\startxmlsetups xml:pandoc
    ...
    \xmlsetsetup{\xmldocument}{html|body|head|div|h1|h2|h3|h4|h5|h6|p|blockquote|span|em|q|b|pre|code|strong|a|ul|ol|li|dl|dt|dd|hr|br|sup|sub}{xml:*}
    ...
    \xmlsetsetup{\xmldocument}{span[contains(@class,'texlogo')]}{xml:tex:logo}
    ...
    \xmlsetsetup{\xmldocument}{div[contains(@class,'tight')]/ul}{xml:ul:packed}
...
\startxmlsetups xml:pre
    \begingroup\tt\xmlflushspacewise{#1}\endgroup\par
\stopxmlsetups
...
%%% Default image from (converted to PDF by me):
%%% https://openclipart.org/detail/191811/
%%% TypographyTribute can be found at:
%%% http://www.dafont.com/typographytribute.font

\def\CoverImageFile{\externalfigure[simpleoldtypewriter][scale=400]}
