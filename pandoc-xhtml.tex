\startxmlsetups xml:pandoc
    ...
    \xmlsetsetup{\xmldocument}
        {[contains(@class,'smcp') or contains(@class,'author')]}
        {xml:smallcaps}
    ...
    \xmlsetsetup{\xmldocument}
        {span[@label or contains(@class,'tex-logo')]}
        {xml:tex:logo}
    ...
    \xmlsetsetup{\xmldocument}
        {[contains(@class,'tex-logo')]/(sup|sub)}
        {xml:texlogo:sup:sub}
...
\startxmlsetups xml:titlepages
    ...
    \startcoverpagemakeup
        ...
        %~ \xmlconcat{#1}{/h2[contains(@class,'author')]}{\\}\par}
        \vfill
        ...
        \doiftext{\xmltext{#1}{h1[@class='subtitle']}}
            ...
            \dontleavehmode\scale[width=.75\textwidth]%
                ...
                %~ {\em \xmltext{#1}{h1[@class='subtitle']}}}
        \stopalign
        \vfill
        \startalign[center]
    ...
    \starttitlepagemakeup
        ...
        %~ {\itd\setupinterlinespace\xmltext{#1}{h1[@class='title']}
                \par}\blank[big]
        \doiftextelse{\getvariable{titlepage}{subtitle}}{
        %~ \doiftextelse{\xmltext{#1}{h1[@class='subtitle']}}{
            {\resetbreakpoints\itb\setupinterlinespace
            \getvariable{titlepage}{subtitle}\par}\blank[3*big]
            %~ \xmltext{#1}{h1[@class='subtitle']}\par}\blank[3*big]
...
\startxmlsetups xml:leftalignblock
    \startalign[right]\setupindenting[no]
        \xmlflush{#1}
    \stopalign
\stopxmlsetups
